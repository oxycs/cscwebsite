...
<div class="page">
    ...
    <Arrowitem img="/img/serverroom.png" imgalt="Server Room" title="Need a place to host your CS project?" description="We'll host it for you on the Computer Science Club's server! Email us to learn more." url={emailAddr}></Arrowitem>
